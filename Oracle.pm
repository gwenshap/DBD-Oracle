...
handle's 'LongReadLen' attribute is set to a value that will exceed the expected size of the LOB. 
...
Will select out all of the LOBs in the table as long as they are all under 2 Megabytes in length.
