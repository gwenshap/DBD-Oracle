...
CCFLAGS = -Zi -nologo -GF -W3 -MD -Zi -DNDEBUG  -DWIN32 -D_CONSOLE -DNO_STRICT -DHAVE_DES_FCRYPT -DNO_HASH_SEED -DUSE_SITECUSTOMIZE -DPERL_IMPLICIT_CONTEXT -DPERL_IMPLICIT_SYS -DUSE_PERLIO -DPERL_MSVCRT_READFIX
...
.c.i:
	cl -nologo -E -Zi -c $(PASTHRU_INC) $(INC) \
	$(CCFLAGS) $(OPTIMIZE) \
	$(PERLTYPE) $(MPOLLUTE) $(DEFINE_VERSION) \
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "version:      1.18" >> META_new.yml
	$(NOECHO) $(ECHO) "version_from: Oracle.pm" >> META_new.yml
...
ppd:
	$(NOECHO) $(ECHO) "<SOFTPKG NAME=\"$(DISTNAME)\" VERSION=\"1,18,0,0\">" > $(DISTNAME).ppd
